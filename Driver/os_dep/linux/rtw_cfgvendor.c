...
#else
#define rtw_cfg80211_vendor_event_alloc(pwdev, len, event_id, gfp) \
	cfg80211_vendor_event_alloc(pwdev->wiphy, pwdev, len, event_id, gfp)
 ...
 * be used).
 */
int rtw_cfgvendor_send_async_event(struct wireless_dev *pwdev,
	struct net_device *dev, int event_id, const void  *data, int len)
{
	...
	skb = rtw_cfg80211_vendor_event_alloc(pwdev, len, event_id, kflags);
	if (!skb) {
